...
headers = {'instance_id': 'lwt-03', 'instance_url': "http://127.0.0.1:8004"}
...
# 3. 报告蹲饼器对某平台异常测试
headers = {'instance_id': 'lwt-02'}
url = 'http://127.0.0.1:{}/report'.format(port)
...
headers = {'instance_id': 'lwt-02'}
url = 'http://127.0.0.1:{}/fetcher-get-config'.format(port)
res = requests.get(url, headers=headers)
print('测试蹲饼器获取配置：')
...
url = 'http://127.0.0.1:{}/standalone-fetcher-get-config'.format(port)
